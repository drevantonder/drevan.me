  ...
  return (
    <>
      <article className="max-w-4xl">
        ...
        >
          Capturing this <span className="text-cyan-400 font-semibold"
            >beautiful universe</span
          > one photo at a time
        </h2>

        <h2 className="text-sm mt-8 text-purple-200 uppercase">Follow me on</h2>
        {/* <div class="flex mt-1 space-x-5">
          <a
            ...
            rel="noopener"
          >
            <BrandLogoFacebook class="h-10 w-auto" />
          </a>
          <a
            ...
            rel="noopener"
          >
            <BrandLogoInstagram class="h-10 w-auto" />
          </a>
          <a
            ...
            rel="noopener"
          >
            <BrandLogoTwitter class="h-10 w-auto" />
          </a>
          <a
            ...
            rel="noopener"
          >
            <BrandLogoYoutube class="h-10 w-auto" />
          </a>
        </div> */}
    </article>
    </>
